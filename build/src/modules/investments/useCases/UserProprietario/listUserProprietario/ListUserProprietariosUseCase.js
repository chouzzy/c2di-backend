...
exports.ListUserProprietarioUseCase = void 0;
    ...
    execute(listUserProprietarioData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.userInvestmentRepository.filterUserProprietario(listUserProprietarioFormatted);
                return response;
            }
            catch (error) {
                throw error;
...
exports.ListUserProprietarioUseCase = ListUserProprietarioUseCase;
