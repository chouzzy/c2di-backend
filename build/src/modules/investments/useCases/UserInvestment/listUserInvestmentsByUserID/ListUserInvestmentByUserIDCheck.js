...
const ListUserInvestmentByUserIDSchema_1 = require("./ListUserInvestmentByUserIDSchema");
function checkQuery(listUserInvestmentData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield ListUserInvestmentByUserIDSchema_1.listUserInvestmentByUserIDSchema.validate(listUserInvestmentData, {
                abortEarly: false
            });
        }
        catch (error) {
