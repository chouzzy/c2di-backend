...
const userProprietarios_routes_1 = require("./userProprietarios.routes");
...
router.use('/usersProprietarios', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, userProprietarios_routes_1.userProprietariosRoutes);
